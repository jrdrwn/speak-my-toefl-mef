...
const LONGMAN_LISTENING_SECTIONS = [
  {
...
const LONGMAN_LISTENING_QUESTIONS: Question[] = LONGMAN_LISTENING_SECTIONS.flatMap((section) => section.questions);

export default LONGMAN_LISTENING_SECTIONS;

module.exports = { LONGMAN_LISTENING_SECTIONS };